...
RELEASE_URL="https://github.com/larrikinau/overseerr-content-filtering/releases/download/v1.1.6"
TARBALL_NAME="overseerr-content-filtering-v1.1.6-ubuntu.tar.gz"
