...
RELEASE_URL="https://github.com/larrikinau/overseerr-content-filtering/releases/download/v1.3.0"
TARBALL_NAME="overseerr-content-filtering-v1.3.0-ubuntu.tar.gz"
