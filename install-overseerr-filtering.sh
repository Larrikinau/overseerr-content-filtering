...
RELEASE_URL="https://github.com/larrikinau/overseerr-content-filtering/releases/download/v1.3.5"
TARBALL_NAME="overseerr-content-filtering-v1.3.5-ubuntu.tar.gz"
...
TMDB_API_KEY=8d7fa4b62f7a2b0e6d5f8c9a1e3b4d7c
EOF
